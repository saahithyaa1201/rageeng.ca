...
export const Route = createFileRoute('/portfolio/premise-isolation')({
  component: PremiseIsolationPage,
});

function PremiseIsolationPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="flex flex-col lg:flex-row lg:gap-32">
            ...
            <div className="flex-1 max-w-4xl">
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 mt-2">
                About the Office Projects
              </h1>
              <div className="text-lg leading-relaxed text-ink/70 space-y-6 mb-12 max-w-3xl">
                <p>
                  Single office project emphasizing efficient layouts, high-performance systems, and comfort. We paid attention to every little detail and kept our awesome clients at the center of it all. We wanted to make sure that the facilities we delivered were nothing short of inspiring. In the end, it turned out to be an absolute blast.
                </p>
              </div>
